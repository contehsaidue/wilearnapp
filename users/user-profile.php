...
<main class="container">
  ...
  <img src="../<?php echo $_SESSION['photo'];?>" alt="<?php echo $_SESSION['userid'];?>" width="48" height="38" class="me-2">
    <div class="lh-1">
      <h1 class="h6 mb-0 text-white lh-1"><?php echo $_SESSION['firstname'].' '.$_SESSION['lastname'];?>
        <span> <a href="#" class="text-decoration-none  fw-bold btn btn-dark btn-sm"> <i class="fas fa-marker"></i></a></span>
</h1>
  ...
  ?>
    ...
    <small class="d-block text-end mt-3">
      <a href="#" class="text-decoration-none text-dark fw-bold">Back</a>
    </small>
  </div>
